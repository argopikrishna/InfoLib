...
class book : public LibraryItem
{
	...
	public:
		...
		void display();
		void showlist();
		void assignbook(int x)       //bno assigned on the basis of no
...
void book::create()							//To enter data in data members of class book
{
	int i;
	cout<<"\n\t\tEnter the details:-\n";
	cout<<"\n\t\tEnter Book's Name: ";
...
void book::display()											//To display the details of books
{
	cout<<"\n\t\tBook No.: "<<bno<<el;
	cout<<"\n\t\tBook Name: "<<bname<<el;
...
void write_student()
{
	...
	outf.seekp(0,ios::end);//set the position of the pointer in the output sequence with spec pos
	st.creates();
	st.shows();
